...
# ..  pres_pr_intrv,enth_pr_intrv,temp_pr_intrv,satn_pr_intrv,iprsat[I]
     100000.0     100000.0     100000.0     100000.0     0
# PRINT 2
...
# PRINT 1
# ..  pres_pr_intrv,enth_pr_intrv,temp_pr_intrv,satn_pr_intrv,iprsat[I]
    100000     100000     100000.0     100000.0     3
# PRINT 2
# ..  dens_pr_intrv,iprden[I],vis_pr_intrv,iprvis[I],potential_pr_intrv,iprpot[I]
     100000    11     0    0     0    0
# PRINT 3
...
def modify_input_sources_tante(flux, Tbot, HPperm, HPporo, LPperm, LPporo, inmass, intemp, dZ):
    texto ="""# Hydrotherm Data-Input Form
# Version 3.2
#      Notes:
#      Syntax of input line is denoted by # ..
...
#SOURCE/SINK
NODE, (kg/s), (deg C)
1   0   1 {inmass:.1f}  {intemp:.1f}
2   0   1 {inmass:.1f}  {intemp:.1f}
3   0   1 {inmass:.1f}  {intemp:.1f}
4   0   1 {inmass:.1f}  {intemp:.1f}
5   0   1 {inmass:.1f}  {intemp:.1f}
6   0   1 {inmass:.1f}  {intemp:.1f}
7   0   1 {inmass:.1f}  {intemp:.1f}
8   0   1 {inmass:.1f}  {intemp:.1f}
9   0   1 {inmass:.1f}  {intemp:.1f}
10  0   1 {inmass:.1f}  {intemp:.1f}
11  0   1 {inmass:.1f}  {intemp:.1f}
12  0   1 {inmass:.1f}  {intemp:.1f}
13  0   1 {inmass:.1f}  {intemp:.1f}
14  0   1 {inmass:.1f}  {intemp:.1f}
15  0   1 {inmass:.1f}  {intemp:.1f}
16  0   1 {inmass:.1f}  {intemp:.1f}
0, 0, 0, 0., 0.
# TIME PERIOD #3  (instantaneous emplacement of magma)
# .. tchg,delt,nsrce[I],lchgpr[T/F],nparms[I]
    172800000.0     -1     -1     F     0
...
#------------------------------------------------------------------------------
#------------------------------------------------------------------------------
""".format(deltaZ=dZ, heat=flux, Tbot=Tbot, HPporo=HPporo, LPporo=LPporo, LPperm=LPperm, HPperm=HPperm, inmass=inmass, intemp=intemp)
    return texto


def modify_input_sources(flux, Tbot, gradT,  HPperm, HPporo, LPperm, LPporo, inmass, intemp, dZ):
    texto ="""# Hydrotherm Data-Input Form
# Version 3.2
#      Notes:
#      Syntax of input line is denoted by # ..
...
#------------------------------------------------------------------------------
#------------------------------------------------------------------------------
""".format(deltaZ=dZ, flux=flux, gradT = gradT, HPporo=HPporo, LPporo=LPporo, LPperm=LPperm, HPperm=HPperm, inmass=inmass, intemp=intemp)
    return texto



def modify_input_sourcesOLD(flux, Tbot, HPperm, HPporo, LPperm, LPporo, inmass, intemp, dZ):
    texto ="""# Hydrotherm Data-Input Form
# Version 3.2
#      Notes:
#      Syntax of input line is denoted by # ..
